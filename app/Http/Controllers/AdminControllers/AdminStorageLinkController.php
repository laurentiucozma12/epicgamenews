...
class AdminStorageLinkController extends Controller
{
    public function storageLink() {
        ...
        // NEW Code, I tested it on DEVELOPMENT and it works
        // I did NOT tested it on PRE-PRODUCTION & PRODUCTION
        if ($currentBranch === 'development' || $currentBranch === 'pre-production' || $currentBranch === 'production') {
