...
<header>
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box">
                <img src="{{ asset('storage/placeholders/user_placeholder.jpg') }}" class="user-img" alt="user avatar">
                <div class="user-info ps-3 pt-3 d-flex align-items-center">
                    
                    <div class="admin-login-btn-container">
                        @auth
                            <p class="user-name mb-0">{{ auth()->user()->name }}</p>
                            <p class="designattion mb-0">
                                <a onclick="event.preventDefault(); document.getElementById('nav-logout-form').submit()" href="">Logout</a>
