    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">All Others</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body p-4">
                <h5 class="card-title">Add New Other</h5>
                <hr/>

                <form action="{{ route('admin.others.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <button class='btn btn-primary' type='submit'>Add Other</button>
