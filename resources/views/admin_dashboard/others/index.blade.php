        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    ...
                    <div class="ms-auto"><a href="{{ route('admin.others.create') }}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add New Other</a></div>
                </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="mb-0 font-14">P-{{ $other->id }}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>{{ $other->name }}</td>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="{{ route('admin.others.edit', $other) }}" class=""><i class='bx bxs-edit'></i></a>
