                                            ...
                                            <div class="com-md-8">
                                                <div class="card shadow-none border">
                                                    <div class="card-body">
                                                        ...
                                                        <h5>Cropped Image</h5>
                                                        <img id="croppedImage" src="/storage/{{ $video_game->image ? $video_game->image->path : 'placeholders/thumbnail_placeholder.jpg' }}" class="cropped-thumbnail-edit" alt="Cropped image">
