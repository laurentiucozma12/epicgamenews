...
<div class="ads-container d-flex justify-content-center">
    ...
    <div>
        <a href="https://www.youtube.com/channel/UCIAsnVTEisj84cRfjqLCcRw?sub_confirmation=1" target="blank">
            <h4 class="hymerra-title youtube-color"><span>HYMERRA THE</span><br>BARBARIAN</h4>
            <h4 class="subscribe youtube-color">SUBSCRIBE <br><span class="youtube"><i class="icon-youtube"></i></span></h4>
        </a>
    </div>
</div>