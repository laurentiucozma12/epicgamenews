            ...
            <div class="col-12">
                <figure class="animate-box thumbnail-container">
                    <picture>
                        ...
                        <source media="(min-width: 481px)" sizes="764px" srcset="{{ asset($post->image ? 'storage/images/764x431/' . $post->image->name : 'storage/placeholders/thumbnail_placeholder.jpg') }}">
                        <source media="(min-width: 0px)" sizes="480px" srcset="{{ asset($post->image ? 'storage/images/764x431/' . $post->image->name : 'storage/placeholders/thumbnail_placeholder.jpg') }}">
